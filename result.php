        ...
        echo "<div class='container'>
              ...
              switch($msg){
                ...
                case 'helthy':
                    ...
                    break;
                case 'eat':
                    echo "<div class='one'><p id='validateAllquestion'>Wir empfehlen das das Abo, mit einem Ernärungs-choatsch.</p></div></div>";
                    break;
                case 'sport':
                        echo "<div class='one'><p id='validateAllquestion'>Wir empfehlen das das Abo, mit einem Fittnes-choatsch.</p></div></div>";
                        break;
                case 'unhalthy':
